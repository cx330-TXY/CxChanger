...
> **Attribution / Credit**: This repository is an English translation of [cx330-TXY/CxChanger](https://github.com/cx330-TXY/CxChanger) (低成本预热式换热端多材料打印), created by [cx330-TXY](https://github.com/cx330-TXY). All design work, CAD models, configurations, and documentation are the work of the original author. This translation preserves the full commit history of the upstream project and is distributed under the same [GNU GPLv3 license](LICENSE). Translated content includes the README, Klipper configuration comments/messages, BOM spreadsheet, file names, and component/body names inside the STEP files. For the latest updates, see the original repository.
